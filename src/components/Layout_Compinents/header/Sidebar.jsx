...
import AlertCard from './AleartCard'
    ...
    <nav className='sidebar'>
      ...
      <div className='dropdown'>
        <div className='fx logo ' role="button" data-bs-toggle="dropdown" aria-expanded="false"  >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-down mt-2 mx-2" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708" />
          </svg>
        </div>


        <ul className="dropdown-menu  blear-logout mt-1 ">
          <li>
        ...
        <ul className=' d-grid gap-1 menu-drop-list' >
          ...
          <li className='fx '>
            <button className='menu-butt active'>
          ...
          <li className='fx '>
            <button className='menu-butt'>
              ...
              <b className='mx-2 '>Add Parties</b>
            </button>
          </li>
