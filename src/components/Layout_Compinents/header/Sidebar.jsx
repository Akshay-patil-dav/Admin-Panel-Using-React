            ...
            <div class="modal-body">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text searchbox-icon" id="basic-addon1">
...
export default function Sidebar() {
    ...
    // Use Searchpopup as a module/component
      ...
      <nav className='sidebar'>
        ...
        <div className='dropdown'>
          <div className='fx logo ' role="button" data-bs-toggle="dropdown" aria-expanded="false"  >
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtP7zw_PzuCGPTQpFX5zhT33JxTx7BNupWZQ&s" alt="" className='circal-slide' />
            {/* <h5 className='hed_logo mt-2 mx-2'><b>Akshay Patil</b></h5> */}
          ...
          <ul className='mt-5'>
            ...
            <li className='fx '>
              <button className='search-butt' data-bs-toggle="modal" data-bs-target="#exampleModal">
